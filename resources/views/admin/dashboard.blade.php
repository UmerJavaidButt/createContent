            ...
            <div class="dashboard-nav">
                <div class="dashboard-nav-inner">
                    ...
                    <ul data-submenu-title="Start">
                        ...
                        <li><a href="#"><i class="icon-material-outline-question-answer"></i> Cetagories Addition</a></li>
                        <!-- <li><a href="#"><i class="icon-material-outline-star-border"></i>  </a></li> -->
                        <li><a href="#"><i class="icon-material-outline-rate-review"></i> Sub-Cetagories Addition </a></li>
                        <li><a href="#"><i class="icon-material-outline-rate-review"></i> Package Addition </a></li>
                    </ul>
                    ...
                    <ul data-submenu-title="Organize and Manage">
                        <li><a href="#"><i class="icon-material-outline-business-center"></i> Users </a>
                            <ul>
                                <li><a href="#">Manage Constestors</a></li>
                                <li><a href="#">Manage Constestants</a></li>
                            </ul>	
                        </li>
                    </ul>

                    <ul data-submenu-title="Organize and Manage">
                        <li><a href="#"><i class="icon-material-outline-business-center"></i> View </a>
                            <ul>
                                <li><a href="#">View Contests</a></li>
                                <li><a href="#">View Contest Submissions</a></li>
                            </ul>	
                        </li>
                    </ul>

                    <ul data-submenu-title="Organize and Manage">
                        <li><a href="#"><i class="icon-material-outline-business-center"></i> Support </a>
                            <ul>
    ...
    <div class="dashboard-content-inner" >
        ...
        <div class="fun-facts-container">
            ...
            <div class="fun-fact" data-fun-fact-color="#b81b7f">
                <div class="fun-fact-text">
                    <span>Rersultless Contests!</span>
                    <h4>14</h4>
                </div>
                        ...
                        <ul class="dashboard-box-list">
                            <li>
                                ...
                                <strong>Professional Plan</strong>
                                    <ul>
                                        <li><span class="unpaid">Incomplete</span></li>
                                        <li>Contest: #326</li>
                            ...
                            <li>
                                ...
                                <strong>Professional Plan</strong>
                                    <ul>
                                        <li><span class="paid">Complete</span></li>
                                        <li>Contest: #264</li>
