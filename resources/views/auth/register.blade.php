						...
						<div class="popup-tabs-container">
							...
							<div class="popup-tab-content" id="register">
								...
								<div class="account-type">
									<div>
										<input type="radio" name="contestant" value="contestant" id="freelancer-radio" class="account-type-radio" checked/>
									...
									<div>
										<input type="radio" name="contestor" value="contestor" id="employer-radio" class="account-type-radio"/>
